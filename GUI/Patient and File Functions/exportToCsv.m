        ...
        while(ischar(line))
            ...
            if ~ignoreTillNextId   
                linesToKeep{i} = struct(...
                    ...
                    'measurementA', str2double(char(split(11))),...
                    'measurementB', str2double(char(split(12))),...
                    'measurementC', str2double(char(split(13))),...
                    'measurementD', str2double(char(split(14))),...
                    'measurementE', str2double(char(split(15))),...
                    'measurementF', str2double(char(split(16))),...
                    'measurementG', str2double(char(split(17))),...
                    'measurementH', str2double(char(split(18))),...
                    'measurementI', str2double(char(split(19))),...
                    'measurementJ', str2double(char(split(20))));
        ...
        for j=1:length(studies)
            ...
            for k=1:length(series)
                ...
                for l=1:length(files)
                    ...
                    if ~isempty(file.metricPoints) && ~isempty(file.refPoints) && ~isempty(file.midlinePoints)
