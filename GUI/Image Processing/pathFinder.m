...
averInterpolValue = interpolate(image, lastPoint);
...
%     curInterpolValue = curInterpolValue / (2*interRadius + 1).^2;
    ...
    averInterpolValue = (averInterpolValue + interpolate(image, curPoint))/2;
...
%         
        ...
        for i=0:width/horizonRes
            ...
            sum = sum + abs(averInterpolValue - interpolate(image, [x,y]));
        end
